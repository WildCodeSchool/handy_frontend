...
//   ) {
//     this._userPayload = this._decodeToken(); // Décodage effectué une seule fois lors de l'initialisation
//   }
...
//     if (!token) return null; // Si aucun token n'est trouvé, on retourne null
