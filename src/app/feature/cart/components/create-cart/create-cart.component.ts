...
export class CreateCartComponent implements OnInit {
  ...
  //     this._cartService.initCartState()
  //       .pipe(
  //         tap(cart => {
  //           this.cart = cart;
  //           this._loadAvailabilityForProviders(cart);
  //         }),
  ...
  //     this._cartService.serviceMap$
  //       .pipe(takeUntilDestroyed(this._destroyRef))
  //       .subscribe(map => this.serviceMap = map);

  //     this._cartService.providerMap$
  //       .pipe(takeUntilDestroyed(this._destroyRef))
  //       .subscribe(map => this.providerMap = map);
  //   }

  //   private _loadAvailabilityForProviders(cart: any[]): void {
  //     const uniqueUserIds = [...new Set(cart.map(item => item.userId))];
  //     uniqueUserIds.forEach(providerId => this.loadAvailabilityForProvider(providerId));
  //   }
